...
import { shouldFocusTabs } from './utils';
...
const StyledDashboardContent = styled.div<{
  ...
  .grid-container {
    ...
    margin-left: ${({ theme, dashboardFiltersOpen }) => {
...
const DashboardBuilder: FC<DashboardBuilderProps> = () => {
  ...
  const dashboardLayout = useSelector<RootState, DashboardLayout>(
    state => state.dashboardLayout && state.dashboardLayout.present,
  );
    ...
    <StyledDiv>
      ...
      <StyledHeader>
        ...
        <DragDroppable
          ...
          style={{
            marginLeft: dashboardFiltersOpen || -32,
          }}
        >
      ...
      <StyledContent fullSizeChartId={fullSizeChartId}>
        <div data-test="dashboard-content" className={cx('dashboard')}>
