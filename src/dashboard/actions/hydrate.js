...
export const hydrateDashboard = (dashboardData, chartData, datasourcesData) => (
  ...
  // console.log('hydrateDashboard', dashboardData, chartData, datasourcesData)
  ...
  return dispatch({
    ...
    data: {
      datasources: keyBy(datasourcesData.result, 'uid') || {},
      ...
      dashboardInfo: {
        ...
        // dash_save_perm: false /* findPermission('can_save_dash', 'Superset', roles) */ ,
        dash_share_perm: false /* findPermission(
          'can_share_dashboard',
          'Superset',
          roles,
        ) */,
        superset_can_explore: false /* findPermission('can_explore', 'Superset', roles) */,
        superset_can_share: false /* findPermission(
          'can_share_chart',
          'Superset',
          roles,
        ) */,
        superset_can_csv: true /* findPermission('can_csv', 'Superset', roles) */,
        slice_can_edit: false /* findPermission('can_slice', 'Superset', roles) */,
        common: {
